...
<header class="navbar sticky-top flex-md-nowrap p-0 shadow bg-warning bg-gradient" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">PT. Maju Jaya</a>
...
<script src="https://getbootstrap.com/docs/5.3/dist/js/bootstrap.bundle.min.js" ></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.3.2/dist/chart.umd.js" ></script><script src="https://getbootstrap.com/docs/5.3/examples/dashboard/dashboard.js"></script></body>
</html>